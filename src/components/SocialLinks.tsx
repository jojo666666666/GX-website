      ...
      {links[lang].map((item) => {
        ...
        return (
          <a
            ...
            className="inline-flex min-h-11 items-center gap-2 rounded-full border border-neutral-300 bg-white px-4 py-2 text-sm font-semibold text-neutral-800 transition hover:border-red-600 hover:bg-red-50 hover:text-red-700"
